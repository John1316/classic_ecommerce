...
class StoreMainRequest extends FormRequest
{
    ...
    {
        return [
            'home_first_ad' => 'required|mimes:jpg,jpeg,png,svg',
            'home_second_ad' => 'required|mimes:jpg,jpeg,png,svg',

            'home_number_banner' => 'required|mimes:jpg,jpeg,png,svg',
            ...
            'home_advantage_first_icon' => 'required|mimes:jpg,jpeg,png,svg',
            ...
            'home_advantage_second_icon' => 'required|mimes:jpg,jpeg,png,svg',
            ...
            'home_advantage_third_icon' => 'required|mimes:jpg,jpeg,png,svg',
            ...
            'home_advantage_fourth_icon' => 'required|mimes:jpg,jpeg,png,svg',
