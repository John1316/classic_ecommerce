...
@if(app()->getLocale() == 'en')
    ...
    <!-- start header -->
    <header class="pageheader d-flex align-items-center" style="background-image: linear-gradient(to top right , rgba(0,0,0,.09), rgba(0,0,0,0.2)) , url({{ asset('banner_images/'. $banner_images->shop_banner_image) }})">
        <div class="container pageheader__caption text-white">
            <h4 class="pageheader__caption--h4">Shop</h4>
            <h6 class="pageheader__caption--h6"><i class="fa fa-home" aria-hidden="true"></i> \ Shop</h6>
        </div>
    </header>
    <!-- end header -->
    ...
    <section class="productlist">
        <div class="container">
            ...
            <section id="products_view" class="mt-7">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="col-lg-4 col-12 mb-5">
                            <div class="card shadow-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="mh-85">{{ mb_substr($product->en_text, 0, 100) }}</p>
...
@else
    ...
    <header class="pageheader d-flex align-items-center" style="background-image: linear-gradient(to top right , rgba(0,0,0,.09), rgba(0,0,0,0.2)) ,url({{ asset('banner_images/'. $banner_images->shop_banner_image) }})">
        <div class="container pageheader__caption text-white">
            <h4 class="pageheader__caption--h4">متجر</h4>
            <h6 class="pageheader__caption--h6"><i class="fa fa-home" aria-hidden="true"></i> \ متجر </h6>
        </div>
    </header>
    <!-- end header -->
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div data-provide="slider" data-autoplay="true" data-autoplay-speed="1000" data-autoplay="true" dir="auto">
                                    <div><img class="h-250px w-100" src="{{ asset('products/'. $product->image) }}"></div>
                                    @foreach($product->productImages as $productImage)
                                        <div><img class="h-250px w-100" src="{{ asset('products/'. $productImage->image) }}"></div>
                                    @endforeach
                            ...
                            <div class="col-lg-6 col-12">
                                ...
                                <p class="mb-3">{{ $product->ar_text }}</p>
                                <div class="price d-flex">
