...
@php $pageTitle = 'Edit Brand'; @endphp
...
@section('content')
    @component('backend.layouts.header', ['navTitle' => 'Edit Brand'])
    ...
    @endcomponent
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="card-body">
                        <form action="{{ route('brands.update', $row->id) }}" method="POST" enctype="multipart/form-data">
                            {{ method_field('put') }}
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <button type="submit" class="btn btn-primary pull-right">Edit Brand</button>
