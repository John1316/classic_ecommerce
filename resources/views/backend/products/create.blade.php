...
@section('content')
    @component('backend.layouts.header', ['navTitle' => 'Add Product'])
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="20" cols="5" name="en_text" class="form-control">{{ old('en_text') }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="20" cols="5" name="ar_text" class="form-control">{{ old('ar_text') }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price_before_discount" class="form-control" value="{{ old('price_before_discount') }}">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price_after_discount" class="form-control" value="{{ old('price_after_discount') }}">
                                    </div>
