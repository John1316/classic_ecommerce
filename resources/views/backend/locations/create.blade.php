...
@php $pageTitle = 'Add Location'; @endphp
...
@section('content')
    @component('backend.layouts.header', ['navTitle' => 'Add Location'])
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="en_location" id="en_location" class="form-control" value="{{ old('en_location') }}">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ar_location" id="ar_location" class="form-control" value="{{ old('ar_location') }}">
                                    </div>
